    ...
    return (
        <div className="about-container">
            <div className="heading-container">
                ...
                <h5>A glimpse into who I am beyond the code</h5>
            </div>
            <div className="about-content">
                ...
                <div className="about-texts">
                    ...
                    <br />
                    <h3><span className="quotes">❝ </span>Turning concepts into code, and code into experiences<span className="quotes"> ❞</span></h3>
                </div>
            </div>
        </div>
