            ...
            <div className="contactContent">
                ...
                <div className="socialMediaLinks">
                    ...
                    <div className="mediaContent" data-aos="fade-right" data-aos-delay="300">
                        <h4>LinkedIn</h4>
                        <a href="https://www.linkedin.com/in/sulymankhalil/" target="_blank" rel="noopener noreferrer">linkedin.com/in/sulymankhalil <i className="fas fa-external-link-alt"></i></a>
                    </div>
                </div>
                <div className="socialMediaLinks">
